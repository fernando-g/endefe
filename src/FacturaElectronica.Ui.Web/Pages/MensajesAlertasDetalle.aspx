    ...
    <div class="editionContainerFilter">
        ...
        <div>
            <p style="vertical-align: top">
                ...
                <asp:TextBox ID="txtMensaje" CssClass="text_area" runat="server" Width="500px" Height="200px" MaxLength="1000"
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                <div id="pnlAsignacionClientes" runat="server">
                    <h2>Clientes destinatarios</h2>
                    <br />
                    <div class="clear">
                    </div>
                    <div id="pnlClientes" runat="server" style="float: left">
                        <asp:ListBox ID="lbxClientes" runat="server" CssClass="lstbox" Width="400px" Height="300px" SelectionMode="Multiple"></asp:ListBox>
                        <br />
                        <span id="lblOrdenar" runat="server">Ordernar por:</span>
                        <asp:RadioButtonList ID="rblOrden" runat="server" RepeatDirection="Horizontal" 
                            AutoPostBack="True" onselectedindexchanged="rblOrden_SelectedIndexChanged">
                    ...
                    <div id="pnlBotones" runat="server" style="float: left; padding: 0 20px 0 20px">
                        <asp:Button ID="btnAgregar" runat="server" Text=">" Width="40px" 
                            onclick="btnAgregar_Click" CausesValidation="false" />
                        <br />
                        <asp:Button ID="btnRemover" runat="server" Text="<" Width="40px" 
                            onclick="btnRemover_Click" CausesValidation="false" />
                        <br />
                        <asp:Button ID="btnAgregarTodos" runat="server" Text=">>" Width="40px" 
                            onclick="btnAgregarTodos_Click" CausesValidation="false" />
                        <br />
                        <asp:Button ID="btnRemoverTodos" runat="server" Text="<<" Width="40px" 
                            onclick="btnRemoverTodos_Click" CausesValidation="false" />
                    </div>
                    <div id="pnlClientesSeleccionados" runat="server" CssClass="lstbox" style="float: left">
                        <asp:ListBox ID="lbxClientesSeleccionados" runat="server" Width="400px" Height="300px" SelectionMode="Multiple">
                        </asp:ListBox>
                    </div>
                </div>
